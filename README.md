...
<details>
  ...
  <ol>
    ...
    <li><a href="#Data-Preparation">Data Preperation</a></li>
    <li><a href="#Observations">Requirements</a></li>
...
1. **Rename Columns:** We start by renaming the 'id' column to 'emp_id' for clarity.
